...
<form class="new_contact_form" id="new_contact_form" data-js="draft" action="mypage.php" accept-charset="UTF-8" method="post">
<div class='plain box-padding'>
<div class='size2 text-primary mbs'>
POINT購入
</div>
<div class='size3'>
テストモードのためポイントの購入はできません。
</div>
</div>
<button name="button" type="submit" class="button large-button flat-button button-primary">戻る
</button>
</form>
