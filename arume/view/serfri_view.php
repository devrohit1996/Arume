...
<form class="" action="serfri.php" method="post" name="serch">
  ...
  <label for="search_form_free_word">ID検索</label>
  </div>
...
　<button name="button" type="submit" class="button  button-primary sign-up_start-button">検索</button>
</form>
</div>
...
<?php if(isset($detail)){ ?>
        ...
        <button name="button" type="submit" class="button  button-primary sign-up_start-button">追加する</button>
        </a>
        </div>
        </div>
<?php } ?>
